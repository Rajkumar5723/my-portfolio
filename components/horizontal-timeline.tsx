...
export default function HorizontalTimeline() {
 ...
 const events: TimelineEvent[] = [
  ...
  {
    date: "Aug 2024",
    title: "Data Scientist Intern (Industrial AI) - Poclain Hydraulics",
    color: "bg-green-500",            
    month: "Aug",
    year: "2024",
    position: "bottom",               
    description:
      "Built industrial AI systems with YOLO-based defect detection, real-time inspection, and predictive analytics for manufacturing quality improvement.",
  },
  {
    date: "Aug 2025",
    title: "Software Developer Intern (AI & ML) - CloudCouch",
    color: "bg-purple-400",           
    month: "Aug",
    year: "2025",
    position: "top",                  
    description:
      "Built ML-enabled product features, booking workflows, and production APIs for a car wash and smart parking application.",
  },
  {
    date: "Dec 2025",
    title: "Data Scientist Intern (AI Agents) - DVS Advisory Group",
    color: "bg-indigo-400",           
    month: "Dec",
    year: "2025",
    position: "bottom",               
    description:
      "Developed LangChain-based AI agents and a RAG tax intelligence system for transfer pricing research, reasoning, and compliance automation.",
  },
];
