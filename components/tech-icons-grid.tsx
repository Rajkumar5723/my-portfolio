...
export default function TechIconsGrid() {
  ...
  const technologies: TechIcon[] = [
    ...
    { name: "AWS", icon: "/icons/aws.svg", color: "bg-[#1A1A2E]" },
    { name: "AZURE", icon: "/icons/Azure.svg", color: "bg-[#1A1A2E]" },
    { name: "Powerbi", icon: "/icons/powerbi.svg", color: "bg-[#1A1A2E]" },
    ...
    { name: "Flask.js", icon: "/icons/flask.svg", color: "bg-[#1A1A2E]" },
