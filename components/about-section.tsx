...
function AboutCard({
  ...
  return (
    <motion.div
      className={`bg-[#0f0f1a] p-6 rounded-lg relative overflow-hidden transition-all duration-300`}
      style={{
        borderWidth: "1px",
        borderStyle: "solid",
    ...
    >
      <div className="flex items-start gap-4">
        <motion.div
          className={`p-3 ${color} rounded-lg`}
          animate={{
        ...
        <div>
          <motion.h3
            ...
            animate={{
              color: isActive ? hoverBorderColor.replace("rgba(", "rgb(").replace(", 0.5)", "") : "#ffffff",
            }}
            transition={{ duration: 0.3 }}
          >
            {title}
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-lg text-gray-300">
            I'm a Data Scientist & AI Developer with a strong backend focus, passionate about building robust and
            ...
            {paragraphs.map((paragraph, index) => (
              ...
              >
                <SummaryParagraph
                  ...
                  borderColor={paragraph.borderColor}
                  glowColor={paragraph.glowColor}
                />
              </motion.div>
            ))}
          </div>
