...
export default function Home() {
  ...
  const allExperience = [
    {
      id: 1,
      title: "Data Scientist Intern (AI Agents)",
      company: "DVS Advisory Group",
      period: "Dec 2025 - Mar 2026",
      location: "Chennai, India",
      highlights: [
        "Built LLM-powered AI agents using LangChain to automate transfer pricing workflows, including industry analysis, FAR profiling, and regulatory research.",
        "Developed a RAG-based Tax Intelligence System with LangChain pipelines, integrating financial documents and regulatory data for context-aware reasoning.",
        "Designed end-to-end ML + LLM pipelines (PyTorch, FastAPI, LangChain) for document ingestion, embedding, retrieval, and automated report generation.",
        "Delivered AI-driven compliance tools that reduced manual effort and improved accuracy and turnaround time for tax professionals.",
      ],
    },
    {
      id: 2,
      title: "Software Developer Intern (AI & ML)",
      company: "CloudCouch",
      period: "Aug 2025 - Mar 2026",
      location: "Remote",
      highlights: [
        "Contributed to the development of a car wash and smart parking web application, delivering end-to-end digital booking and management features.",
        "Designed and implemented the machine learning module, enabling intelligent features such as prediction, automation, and data-driven decision support.",
        "Built and deployed ML models and APIs using Python and FastAPI, integrating them seamlessly into the production system.",
        "Collaborated with cross-functional teams to integrate ML-driven insights into the application, enhancing user experience and operational efficiency.",
      ],
    },
    {
      id: 3,
      title: "Data Scientist Intern (Industrial AI)",
      company: "Poclain Hydraulics",
      period: "Aug 2024 - May 2025",
      location: "Puducherry, India",
      highlights: [
        "Developed YOLO-based computer vision models for automated defect detection in hydraulic components.",
        "Built a real-time inspection system, reducing quality check time by 40%.",
        "Improved product fitting accuracy by 25% using predictive analytics and statistical modeling.",
        "Reduced production errors and costs by 30% through early defect detection and real-time monitoring tools.",
      ],
    },
  ]
