...
export default function ProjectsPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Bridges communication gaps by converting normal and impaired speech into Indian Sign Language (ISL) animations. A smart neckband captures voice input, processed through a real-time NLP pipeline.",
      image: "/images/Voxsign.png?height=400&width=600",
      technologies: ["Speech Processing", "NLP", "Deep Learning", "ISL", "Accessibility"],
      category: "AI",
      link: "/projects/2",
