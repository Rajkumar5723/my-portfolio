...
export default function ProjectPage() {
  ...
  const projects: ProjectData[] = [
    ...
    },
    {
      ...
      description:
        "VoxSign bridges communication gaps by converting normal and impaired speech into Indian Sign Language (ISL) animations. A smart neckband captures voice input, which is processed through a real-time NLP pipeline on the device for speech-to-text translation. The text is then mapped to an avatar-based sign language engine—requiring no external servers, crucial for privacy and low-latency performance.",
      image: "/images/Voxsign.png",
      technologies: ["Speech Processing", "NLP", "Deep Learning", "ISL", "Embedded AI", "Accessibility"],
      category: "AI",
      link: "#",
      ...
      keyFeatures: [
        "Impaired Voice Recognition – Robust training on diverse speech samples.",
        "Real-time Translation – Minimal latency with on-device inference.",
        "Mobile Integration – Android app ensures user-friendly experience.",
        "Expandable – Architecture allows additional sign languages or custom sign dictionaries.",
      ],
      challenges: {
        problems: [
          "Data Scarcity – Collected custom voice samples from volunteers and used data augmentation.",
          "Latency Constraints – Shifted heavy computations to optimized models (TensorFlow Lite) for near-instant results.",
          "Accurate Avatar Sync – Built a dictionary that perfectly aligns text tokens with ISL gestures.",
        ],
        solutions: [
          "Created synthetic speech samples with controlled distortions to simulate speech impairments",
          "Implemented model quantization and pruning to reduce model size by 70%",
          "Developed a custom animation blending system for smooth transitions between signs",
        ],
      },
      techStack: ["Python", "TensorFlow", "Android Studio", "Flask", "Hugging Face"],
      keyLearnings: [
        "Careful model optimization is critical for real-time, on-device ML.",
        "Inclusive design ensures broader accessibility and community impact.",
      ],
    },
    {
      id: 3,
